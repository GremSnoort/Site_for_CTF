...
<section id="facts" class="facts">
		...
		<h2 style="font-family:Arial Black">
                       ...
                       <img  src="img/CTF.jpg" alt="task1" align="middle" vspace="40" height="512"> 
             <h3> <span class="nubex1">P.S. Нашел открытку в архивах Дока. Интересно, как она туда попала?</span><br><br></h3>
