...
<section id="facts" class="facts">
		...
		<h2 style="font-family:Arial Black">
							Flux_capacitor_back_to_the_future</h2> <br>
                          
                          <h1 align=center >					

                       <img  src="img/Flux-capacitor-back-to-the-future.jpg" alt="task1" align="middle" vspace="40" height="1524"> 
             <h3> <span class="nubex1">P.S. Я скоро буду отсуткивать SOS, если ты мне не поможешь. Док оставил подсказку, может, это поможет, но в письме было 64 символа, может, у неё есть другое свойство?</span><br><br></h3>
